...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-4">
            ...
            <asp:TextBox runat="server" ID="txtPerfilNombre" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="Apellido" ID="lblPerfilApellido" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilApellido" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="Documento" ID="lblPerfilDni" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilDni" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="Fecha de Nacimiento" ID="lblPerfilNacimiento" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilNacimiento" CssClass="form-control txtPerfil" ReadOnly="true"/>
        ...
        <div class="col-4">
            ...
            <asp:TextBox runat="server" ID="txtPerfilDomicilio" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="E-mail" ID="lblPerfilEmail" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilEmail" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="Celular" ID="lblPerfilCelular" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilCelular" CssClass="form-control txtPerfil" ReadOnly="true"/>
            <asp:Label Text="Fecha de Alta" ID="lblPerfilAlta" runat="server" cssclass="lblPerfil"/>
            <asp:TextBox runat="server" ID="txtPerfilAlta" CssClass="form-control txtPerfil" ReadOnly="true"/>
        </div>
    </div>
